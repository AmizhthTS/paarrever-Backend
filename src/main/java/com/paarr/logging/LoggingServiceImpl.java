...
import com.paarr.util.LogConfigUtil;
...
public class LoggingServiceImpl implements LoggingService {
	...
	public void displayReq(HttpServletRequest request, Object body) {
		...
		if (logConfigUtil.isLogRequest(request.getRequestURI().replace(contextpath, ""))) {
	...
	public void displayResp(HttpServletRequest request, HttpServletResponse response, Object body) {
		...
		if (logConfigUtil.isLogResponse(request.getRequestURI().replace(contextpath, ""))) {
